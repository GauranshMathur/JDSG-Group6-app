...
| 2 | `Post.search` depends on the adapter; F-6.3 claims parity | [2026-08-18](2026-08-18.md) | Strong | [#84](https://github.com/GauranshMathur/JDSG-Group6-app/issues/84) | **Closed** — [#97](https://github.com/GauranshMathur/JDSG-Group6-app/pull/97). Both scopes fold case and name an ESCAPE; a second bug found on the way ([`fixes.md`](fixes.md)) |
| 3 | `Rails.cache` has no seam — rate limiter inert under test | [2026-08-18](2026-08-18.md) | Strong | [#85](https://github.com/GauranshMathur/JDSG-Group6-app/issues/85) | **Part closed** — the limiter is testable and the five duplicated hooks are gone ([#103](https://github.com/GauranshMathur/JDSG-Group6-app/pull/103)). Hiding `RankedFeed`'s payload shape remains, and bears on [ADR 0010](../adr/0010-stored-rank-score.md) |
| 4 | Nothing owns "a page of a timeline" — `?page=-1` is a 500 on two routes | [2026-08-18](2026-08-18.md) | Strong | [#86](https://github.com/GauranshMathur/JDSG-Group6-app/issues/86) | **Closed** — the 500s by [#94](https://github.com/GauranshMathur/JDSG-Group6-app/pull/94), the interface by [#101](https://github.com/GauranshMathur/JDSG-Group6-app/pull/101). One `TimelinePage`; an unstyled pagination link found on the way ([`fixes.md`](fixes.md)) |
...
| 7 | Image policy lives in a view; `Post#image_variants` is dead | [2026-08-18](2026-08-18.md) | Strong | [#89](https://github.com/GauranshMathur/JDSG-Group6-app/issues/89) | **Closed** — [#100](https://github.com/GauranshMathur/JDSG-Group6-app/pull/100). One `ImagePolicy`; F-7.4 reworded and its real gap recorded as N-7.6 ([`fixes.md`](fixes.md)) |
| 8 | Like and Repost are one module written twice | [2026-08-18](2026-08-18.md) | Worth exploring | [#90](https://github.com/GauranshMathur/JDSG-Group6-app/issues/90) | **Open, deliberately** — the review judges the duplication stable and worth doing "when a third engagement type appears". Abstracting two cases with no third is scaffolding ahead |
| 9 | One rule, several implementations — tags, usernames, the ranking formula | [2026-08-18](2026-08-18.md) | Worth exploring | [#90](https://github.com/GauranshMathur/JDSG-Group6-app/issues/90) | **Closed** — [#104](https://github.com/GauranshMathur/JDSG-Group6-app/pull/104). Each rule has one home; guards checked by mutation ([`fixes.md`](fixes.md)) |
